...
$(function(){
	...
	$('.chooseMain .transModel').click(function(e){
		...
		if ($target.hasClass('transModel')){
			...
			//视模式绑定
			var domStr = '<a class="carousLeftArr pa"><i class="iconB iconLeft"></i></a><div class="imageArea"><img src="https://unsplash.it/1100/415?image=450"></div><a class="carousRightArr pa"><i class="iconB iconRight"></i></a>';
			setTimeout(function(){
				...
				,
				[
		'https://unsplash.it/1100/415?image=450',
		'https://unsplash.it/1100/415?image=440',
		'https://unsplash.it/1100/415?image=430',
		'https://unsplash.it/1100/415?image=420',
		'https://unsplash.it/1100/415?image=410',
		'https://unsplash.it/1100/415?image=560',
		'https://unsplash.it/1100/415?image=160'
	]
				);
			},1000);
